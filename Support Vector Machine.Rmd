---
title: "Week 1 Homework Submission"
author: "Tri Nguyen"
...
In my previous job as a credit analyst at a real estate finance company, I worked to manage commercial mortgage investment portfolios of various clients. One of the tasks in my daily work is to conduct valuation of market price of individual mortgage in those portfolios.


In order to do that, I would need determine the risk rating score for individual mortgage ranging from 1 to 12 with 1 corresponds to lowest level of risk and 12 the highest level of risk. Mortgages with higher level of risk will have a higher discount rate in their valuation.

In this case, there are 12 classes to classify the mortgages into. Hence, a k-Nearest Neighbor algorithm could be appropriate to tackle the task.

There are 5 predictors (attributes) that we considered: 

1/ Location: the city that the collateral property of the mortgage is located in. A rural town or an urban city could affact the risk of the mortgage.

2/ Structural Quaility: whether the collateral property is well maintained and kept in good, quality condition or not.

3/ Tenant Quality: the quality of the tenants occupying the collecteral property. The risk might be lower if the anchor tenant is a multi-national company compared to a local grocery store.

4/ Borrower's Quality: the networth or equity balance of the borrower. If it is a high multiple of the mortgage value, the risk might be lower.

5/ Loan Metrics:  this is the loan to value (LTV) ratio, which is the mortgage amount over the fair market value of the collateral property.
